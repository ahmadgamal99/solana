...
Currently, this will subtract 1 ROX from each allocation and store it in the
recipient address. That ROX can be used to pay transaction fees on staking
...
Distributing SPL Tokens works very similarly to distributing ROX, but requires
...
As with ROX, you can List the differences between a list of expected
