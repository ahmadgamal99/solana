...
Finally we can estimate the _Staked Yield_ on staked ROX, if we introduce an additional parameter, previously discussed, _% of Staked SOL_:

$$
\%~\text{ROX Staked} = \frac{\text{Total ROX Staked}}{\text{Total Current Supply}}
$$
