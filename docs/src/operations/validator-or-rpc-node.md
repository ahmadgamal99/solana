...
cluster consensus. You will want to attract a delegation of ROX to your
...
approximately 1.0 ROX per day.

> It is important to make sure your validator always has enough ROX in its
...
for blocks that they agree with. The cost of voting can be up to 1.1 ROX per
day.

A voting validator can earn ROX through 2 methods:
