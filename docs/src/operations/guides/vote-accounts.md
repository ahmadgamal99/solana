...
the validator operator may choose to store only enough ROX on the identity
...
a vote account withdraws all remaining ROX funds to a supplied recipient address
