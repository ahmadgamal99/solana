...
- [Set up a Nano with the Solana App](https://support.ledger.com/hc/en-us/articles/360016265659-Solana-ROX-?docs=true)
...
Note: Any address with a balance of 0 ROX, such as a newly created one on your
...
account address has some ROX in it.

### Send ROX from a Nano
...
is entered to send `1` ROX to the recipient address
