...
This page describes how to receive and send ROX tokens using the command line
...
$ solana airdrop 1 DYw8jCTfwHNRJhhmFcbXvVDTqWMEVFBX6ZKUmG5CNSKK --url https://api.devnet.solana.com  # Airdropping 1 ROX to my wallet's address/pubkey
Requesting airdrop of 1 ROX from 35.233.193.70:9900
1 ROX
...
0.499995 ROX  # The sending account has slightly less than 0.5 ROX remaining due to the 0.000005 ROX transaction fee payment

$ solana balance 7S3P4HxJpyyigGzodYwHtCxZyUQe9JiBMHyRWXArAaKv --url https://api.devnet.solana.com
0.5 ROX  # The second wallet has now received the 0.5 ROX transfer from the first wallet
...
If you already hold ROX and want to send tokens to someone, you will need
