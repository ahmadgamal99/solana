//! Types for directing the execution of Rox programs.
//!
//! Every invocation of a Rox program executes a single instruction, as
...
//! the Rox runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the Rox runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Rox software versions.
    ///
...
/// A directive for a single invocation of a Rox program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Rox
...
/// construction.
///
/// While Rox is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Rox runtime coalesces all accounts used
...
///
/// Note that because the Rox runtime schedules parallel transaction
...
/// which is the core of a Rox transaction. It is created during the
