...
/// errors. To avoid this, it is common for Rox programs to define an
...
///
/// # Defining a panic handler for Rox
///
/// _The mechanism for defining a Rox panic handler is different [from most
...
/// ```
///
/// The above is how Rox defines the default panic handler.
#[macro_export]
