...
//!
//! In Rox, programs execute instructions, and clients submit sequences
...
//! version as of Rox 1.10.0. `v0` is a [future message format] that encodes
...
//! runtime's messages from within a Rox program, and only the legacy message
//! types continue to be exposed to Rox programs, for backwards compatibility
//! reasons.
