...
//!
//! See also the Rox [documentation on the instructions sysvar][sdoc].
//!
...
///
/// This function is used by the runtime and not available to Rox programs.
#[cfg(not(target_os = "solana"))]
