//! Logging utilities for Rust-based Rox programs.
//!
//! Logging is the main mechanism for getting debugging information out of
//! running Rox programs, and there are several functions available for doing
...
/// for constrained environments like the Rox VM.
///
/// # Examples
///
/// ```
