...
pub mod tests {
    ...
    fn test_confirm_slot_entries_progress_num_txs_indexes() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config(100 * LAMPORTS_PER_ROX);
        let genesis_hash = genesis_config.hash();
        ...
        let keypair3 = Keypair::new();
        let keypair4 = Keypair::new();
        bank.transfer(LAMPORTS_PER_ROX, &mint_keypair, &keypair1.pubkey())
            .unwrap();
        bank.transfer(LAMPORTS_PER_ROX, &mint_keypair, &keypair2.pubkey())
            .unwrap();
