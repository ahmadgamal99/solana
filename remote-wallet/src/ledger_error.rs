...
pub enum LedgerError {
    #[error("Rox app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Rox message")]
    ...
    #[error("Rox summary finalization failed on Ledger device")]
    SolanaSummaryFinalizeFailed = 0x6f00,

    #[error("Rox summary update failed on Ledger device")]
